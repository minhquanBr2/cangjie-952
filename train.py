...
def train(epoch):
    ...
    start = time.time()
    net.train()
    for batch_index, (images, labels) in enumerate(cangjie952_training_loader):
        ...
        n_iter = (epoch - 1) * len(cangjie952_training_loader) + batch_index + 1
        ...
        print('Training Epoch: {epoch} [{trained_samples}/{total_samples}]\tLoss: {:0.4f}\tLR: {:0.6f}'.format(
            ...
            total_samples=len(cangjie952_training_loader.dataset)
        ))
...
if __name__ == '__main__':
    ...
    #data preprocessing:
    cangjie952_training_loader = get_training_dataloader(
        settings.CANGJIE952_TRAIN_MEAN,
        settings.CANGJIE952_TRAIN_STD,
        num_workers=4,
        batch_size=args.b,
        shuffle=True
    )

    cangjie952_test_loader = get_test_dataloader(
        settings.CANGJIE952_TRAIN_MEAN,
        settings.CANGJIE952_TRAIN_STD,
        num_workers=4,
        batch_size=args.b,
